...
See https://github.com/macuenca/goth/blob/master/examples/main.go to see this in action.
*/
package gothic
...
See https://github.com/macuenca/goth/examples/main.go to see this in action.
*/

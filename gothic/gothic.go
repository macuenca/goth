...
See https://github.com/macuenca/goth/v3/blob/master/examples/main.go to see this in action.
*/
package gothic
...
See https://github.com/macuenca/goth/v3/examples/main.go to see this in action.
*/
